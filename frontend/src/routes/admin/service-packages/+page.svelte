...
<svelte:head>
  <title>Service Packages — Admin</title>
</svelte:head>

<div class="container">
  <div class="page-header">
    <div>
      <h1>Service <span class="text-gradient">Packages</span></h1>
      <p class="page-subtitle">Configure bundle quotas and priority for the rating engine</p>
    </div>
