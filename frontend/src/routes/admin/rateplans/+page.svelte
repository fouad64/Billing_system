  ...
  async function openEditModal(plan) {
    ...
    try {
        ...
        if (res.ok) {
            ...
            // Note: the detail API should return servicePackageIds. 
            // If it doesn't, we might need another join or API.
            // For now, we assume the detail API returns them or we'll need to fetch the mapping.
            currentPlan = { 
                ...plan, 
...
<div class="container">
  <div class="page-header">
    <div>
      <h1>Rate <span class="text-gradient">Plans</span></h1>
      <p class="page-subtitle">Define base pricing and default bundled services for customers</p>
    </div>
