...
public class ContractDAO {
    ...
    // ─── SQL WITH JOINS ──────────────────────────────────────
    // A JOIN query combines data from multiple tables.
    // Here we get the Contract data + Customer Name + Rate Plan Name.
    // This is much faster than running 3 separate queries.
